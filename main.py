class AutomaticBrickMover:
    def __init__(self,path="C:\\Users\\12580\\Desktop\\a.docx",picpath="C:\\Users\\12580\\Desktop\\b.jpg",
                 ratingpath="C:\\Users\\12580\\Desktop\\评级调整.xlsx",bond_name=['呼和浩特春华水务开发集团有限责任公司','北京市基础设施投资有限公司']):
     self.path=path
    ...
    def BaiduOcr(self):
        ...
        from PIL import Image
        APP_ID = "24364708"
        API_KEY = "Zg9ZgKGX7GBSuZf7Qv9UG6PR"
        SECRET_KEY = "RfzDjTZhxNomIDWVronjaz2QnVA2GAD4"
...
AutomaticBrickMover(bond_name=['四川蓝光发展股份有限公司','新疆交通建设投资控股有限公司','绍兴市上虞区交通集团有限公司']).create_template_to_new_location()
AutomaticBrickMover().BaiduOcr()
AutomaticBrickMover(path="C:\\Users\\12580\\Desktop\\a.docx").BrickMover()
...
doc_template(excelpath="C:\\Users\\12580\\Desktop\\模板准备.xlsx").search()
doc_template(targetpath="C:\\Users\\12580\\Desktop\\quick1.docx",excelpath="C:\\Users\\12580\\Desktop\\模板准备.xlsx").table_modify()
...
import math
from docx import Document
targetpath="C:\\Users\\12580\\Desktop\\中金_固定收益_210630_中国短期融资券及中期票据信用分析周报test.docx",
sourcepath="C:\\Users\\12580\\Desktop\\中金_固定收益_200902_中国短期融资券及中期票据信用分析周报.docx",
excelpath="C:\\Users\\12580\\Desktop\\模板准备.xlsx",
issuerpath="C:\\Users\\12580\\Desktop\\CP Issue Index -值格式.xlsx"
doc = Document(targetpath)
gs_table = pd.read_excel(excelpath)
issuer = pd.read_excel(issuerpath)
table = doc.tables[1]
...
Solution().lengthOfLastWord(s="aha")
